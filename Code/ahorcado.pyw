...
from palabras import lista_palabras_original
...
right_letter_sound = pygame.mixer.Sound("data\Right_letter.wav")
wrong_letter_sound = pygame.mixer.Sound("data\wrong_letter.wav")

you_win_sound = pygame.mixer.Sound("data\you_win.wav")
you_lose_sound = pygame.mixer.Sound("data\you_lose.wav")
...
icono = pygame.image.load("data\icono_ahorcado.png")
...
while True:
    ...
    if perdio:    # Si perdio que reinicie la lista de palabras
        ...
        # Importo la lista de palabras y lo meto en una nueva lista:
        lista_palabras = lista_palabras_original
...
# __________________________________________________________________________________________
    ...
    # from  esa lista para que sea adivinada:
    palabra = choice(lista_palabras).upper()
    ...
    dibujo = pygame.image.load(f"data\hangman_{contador_error}.png").convert_alpha()
    ...
    for i in ("A","B","C","D","E","F","G","H","I","J","K","L","M","N"):
        letras_fila_1.append((i, pygame.image.load(f"data\letras\{i}.png").convert_alpha()))
    ...
    for i in ("Ñ","O","P","Q","R","S","T","U","V","W","X","Y","Z"):
        letras_fila_2.append((i, pygame.image.load(f"data\letras\{i}.png").convert_alpha()))
